...
def main() -> int:
    ...
    p.add_argument("--folder1", required=True, help="Reference image folder")
    p.add_argument("--folder2", required=True, help="Generated image folder")
    p.add_argument("--output", default="outputs/metrics/compare_folders.json")
    ...
    results = evaluate_folders(
        reference_dir=args.folder1,
        generated_dir=args.folder2,
        device=args.device,
